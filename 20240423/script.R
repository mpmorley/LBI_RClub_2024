...
#We can use any statment that returns a boolean or is a booleen. 
...
#However we don't need the full conditional statment if variable is a boolean. 
...
#Load the bultin Seurat test data and format it a bit
